...
/**
 * ChocolateBatch is a small domain class you can use as a value type for
 * ChocolateHashMap.
 *
 * Example:
 * ChocolateHashMap<String, ChocolateBatch> inventory = new
 * ChocolateHashMap<>();
 * inventory.put("SKU-TRUF-001", new ChocolateBatch("Truffle Box", 72,
 * "Ecuador", 120));
 */
